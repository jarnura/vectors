...
(function(exports) {
  ...
  var VectorPrelude = PS["VectorPrelude"];
...
(function(exports) {
  ...
  var transformation = function (key) {
      if (key === "ArrowLeft") {
          return rotateY(Utils.incSpeed(Data_Unit.unit));
      };
      if (key === "ArrowRight") {
          return rotateY(-1.0 * Utils.incSpeed(Data_Unit.unit));
      };
      if (key === "ArrowUp") {
          return rotateX(Utils.incSpeed(Data_Unit.unit));
      };
      if (key === "ArrowDown") {
          return rotateX(-1.0 * Utils.incSpeed(Data_Unit.unit));
      };
      return rotateZ(0.0);
  };
  ...
  var changeOrigin = Data_Maybe.maybe(LinearAlgebra_Matrix.zeros(2)(1))(Control_Category.identity(Control_Category.categoryFn))(LinearAlgebra_Matrix.fromArray(2)(1)([ 500.0, 500.0 ]));
  var projectOn2d = function ($1) {
      return Data_Functor.map(Data_Functor.functorArray)(LinearAlgebra_Matrix.add(changeOrigin))(Data_Functor.map(Data_Functor.functorArray)(LinearAlgebra_Matrix.multiply(transform3dMatrixTo2dMatrix))($1));
  };
  exports["transform3dMatrixTo2dMatrix"] = transform3dMatrixTo2dMatrix;
  exports["projectOn2d"] = projectOn2d;
  exports["changeOrigin"] = changeOrigin;
  exports["identityMatrix_2_4"] = identityMatrix_2_4;
...
(function(exports) {
  ...
  var VectorPrelude = PS["VectorPrelude"];
  var renderSide = function ($0) {
      return Graphics_Drawing.outlined(Data_Semigroup.append(Graphics_Drawing.semigroupOutlineStyle)(Graphics_Drawing.outlineColor(Color.black))(Graphics_Drawing.lineWidth(0.5)))(Graphics_Drawing.closed(Data_Foldable.foldableArray)($0));
  };
  ...
  var drawEdges = function (points) {
      var to = function (x) {
          return Utils.vectorToPoint(Data_Maybe.fromMaybe(LinearAlgebra_Matrix.zeros(2)(1))(Data_Array.index(points)(Data_Maybe.fromMaybe(0)(Data_Array.index(x)(1)))));
      };
      var from = function (x) {
          return Utils.vectorToPoint(Data_Maybe.fromMaybe(LinearAlgebra_Matrix.zeros(2)(1))(Data_Array.index(points)(Data_Maybe.fromMaybe(0)(Data_Array.index(x)(0)))));
      };
  ...
  var renderCube = function (trans) {
      return function ($1) {
          return (function ($2) {
              return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Graphics_Drawing.monoidDrawing)(renderSide)(drawEdges(Vector.projectOn2d($2)));
          })(Utils.storeMatrix(Data_Functor.map(Data_Functor.functorArray)(LinearAlgebra_Matrix.multiply(trans))($1)));
      };
  };
  var cubePoints = Data_Functor.map(Data_Functor.functorArray)(LinearAlgebra_Vector.mulScalar(0.5))([ point1, point2, point3, point4, point5, point6, point7, point8 ]);
...
(function(exports) {
  ...
  var scene = function (keyboard) {
      return function (mouse) {
          return function (v) {
              var init = (function ($31) {
                  return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Graphics_Drawing.monoidDrawing)(Cube.renderSide)(Cube.drawEdges($31));
              })(Vector.projectOn2d(Utils.getCachedMatrix(Data_Unit.unit)));
              ...
              var keyboardEvent = function (value) {
                  return function (v1) {
                      return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(background)(Cube.renderCube(Vector.transformation(value))(Utils.getCachedMatrix(Data_Unit.unit)));
                  };
              };
              var mouseEvent = function (v1) {
                  if (v1 instanceof Data_Maybe.Just) {
                      var ydeg = Data_Int.toNumber(v1.value0.y) - Utils.getY(Data_Unit.unit);
                      var xdeg = Data_Int.toNumber(v1.value0.x) - Utils.getX(Data_Unit.unit);
                      var v2 = Utils.storeX(Data_Int.toNumber(v1.value0.x));
                      var v3 = Utils.storeY(Data_Int.toNumber(v1.value0.y));
                      var trans = LinearAlgebra_Matrix.multiply(Vector.rotateX(-(ydeg * 0.1)))(Vector.rotateY(xdeg * 0.1));
                      return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(background)(Cube.renderCube(trans)(Utils.getCachedMatrix(Data_Unit.unit)));
                  };
                  if (v1 instanceof Data_Maybe.Nothing) {
                      return background;
                  };
                  throw new Error("Failed pattern match at Main (line 25, column 9 - line 25, column 55): " + [ v1.constructor.name ]);
              };
  ...
  var main = function __do() {
      ...
      var v1 = Utils.storeMatrix(Cube.initcube);
      var v2 = Graphics_Canvas.getContext2D(canvas)();
      var v3 = Graphics_Canvas.getCanvasWidth(canvas)();
      var v4 = Graphics_Canvas.getCanvasHeight(canvas)();
      var v5 = Graphics_Canvas.setCanvasWidth(canvas)(v3)();
      var v6 = Graphics_Canvas.setCanvasHeight(canvas)(v4)();
      var v7 = FRP_Event_Keyboard.getKeyboard();
      var v8 = FRP_Event_Mouse.getMouse();
      var v9 = FRP_Behavior.animate(scene(v7)(v8)({
          w: v3,
          h: v4
      }))(Graphics_Drawing.render(v2))();
      return Data_Unit.unit;
  };
  exports["scene"] = scene;
  exports["main"] = main;
