...
(function(exports) {
  ...
  var Partial_Unsafe = PS["Partial.Unsafe"];
  var Prelude = PS["Prelude"];                 
  var transform3dto2d = Data_Maybe.maybe(LinearAlgebra_Matrix.zeros(2)(4))(Control_Category.identity(Control_Category.categoryFn))(LinearAlgebra_Matrix.fromArray(2)(4)([ 2.0 + 1, 0, 0, 0, 0, 2.0 + 1, 0, 0 ]));
  var scalar = [ 2.0 ];
  ...
  var projection2d = function ($30) {
      return Data_Functor.map(Data_Functor.functorArray)(LinearAlgebra_Matrix.add(Data_Maybe.maybe(LinearAlgebra_Matrix.zeros(2)(1))(Control_Category.identity(Control_Category.categoryFn))(LinearAlgebra_Matrix.fromArray(2)(1)([ 1000.0, 800.0 ]))))(Data_Functor.map(Data_Functor.functorArray)(LinearAlgebra_Matrix.multiply(transform3dto2d))($30));
  };
