  ...
  var scene = function (mouse) {
      return function (v) {
          ...
          var renderSide = function ($32) {
              return Graphics_Drawing.outlined(Data_Semigroup.append(Graphics_Drawing.semigroupOutlineStyle)(Graphics_Drawing.outlineColor(Color.black))(Graphics_Drawing.lineWidth(0.5)))(Graphics_Drawing.closed(Data_Foldable.foldableArray)($32));
          };
